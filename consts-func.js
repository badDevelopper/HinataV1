...
const { sendVideoAsSticker, sendImageAsSticker } = require("./dados/org/sticker/rename.js");

const { sendVideoAsSticker2, sendImageAsSticker2 } = require("./dados/org/sticker/rename2.js");

const { validmove, setGame } = require("./dados/org/tictactoe");

const { wait, getExtension, generateMessageID, getMembros, getGroupAdmins, getRandom, banner, banner2, banner3, temporizador, chyt, getBuffer, fetchJson, fetchText, getBase64, convertSticker, nit, supre, recognize, FormData } = require("./dados/org/funcoes/functions.js"); // FUNÇÕES NESCESSARIAS PRA FUNFAR ALGUMAS COISAS

// JSON FUNÇÕES ABAIXO CONSTS >

const rg_aluguel = JSON.parse(fs.readFileSync("./dados/org/json/rg_aluguel.json"));
...
try {
var recolherLNK = JSON.parse(fs.readFileSync("./dados/org/funcoes/recolherLNK.json"));
} catch (e) {
...
const bloq_global = JSON.parse(fs.readFileSync("./dados/global/bloqueargb.json"))
...
fetchText, getBase64, upload, nit, validmove, setGame, supre, wait, 
getExtension, generateMessageID, getGroupAdmins, 
getMembros, getRandom, banner, banner2, banner3,
temporizador, chyt, simih, Limit_CMD,

// JSON FUNÇÕES ABAIXO >
rggold, antispam, anotar, countMessage, recolherLNK, daily, 
nescessario, premium, ban, black_, rgp, rg_aluguel, infos, bloq_global,
...
menu, menudono, adms, menulogos, 
efeitos, menuprem, brincadeiras, infodono, gitdobot, 
configbot, cmd_termux, alteradores, tabela, conselhob, palavrasc, 
