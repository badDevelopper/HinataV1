...
// PEGAR DESCRIÇÃO DO GRUPO. /BRNQEBRNA
...
case 'connecting':
console.log(colors.green('CONECTANDO.. Hinata 4.1'))
break;

case 'open':
console.log(banner3.string)   
console.log(banner2.string)
console.log(colors.green(`〔 - _ Hinata MD 1.0 _ - CONECTADO COM SUCESSO.. 〕`));
rl.close();
